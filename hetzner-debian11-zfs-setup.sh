...
cp /etc/ssh "$c_zfs_mount_dir/etc/ssh"

cat "$c_zfs_mount_dir/root/.ssh/authorized_keys"
cat "$c_zfs_mount_dir/etc/ssh/sshd_config"

chmod 0700 "$c_zfs_mount_dir/root"
chmod 0600 "$c_zfs_mount_dir/root/.ssh"
chmod 0600 "$c_zfs_mount_dir/root/.ssh/authorized_keys"
